...
diabetes = pd.read_csv(r'C:\Users\USER\Desktop\diabetes cleaned8.csv')
...
st.image(r"C:\Users\USER\Desktop\diabetes.jpg", use_column_width=True)
...
diabetic_filter = st.checkbox("Show Diabetic Cases")
...
# Create a checkbox for filtering diabetic cases
diabetic_filter = st.checkbox("Show Diabetic Cases", key="diabetic_filter")
...
# Create a checkbox for filtering diabetic cases
diabetic_filter = st.sidebar.checkbox("Show Diabetic Cases")
